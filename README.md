...
Ответвление проекта LazyWinAdmin выпущенного в 2012 году.
Представляет из себя PowerShell скрипт с  Windows GUI.
Утилита помагает системному администратору иметь в одном интерфейсе все необходимые инструменты для повседневной работы 

Формы созданы Sapien Powershell Studio 2012.
...
* Powershell 2.0
* Права позволяющее выполнять скрипты на удаленной системе

## Не обязательные внешние инструменты
